...
public interface ReplyService {
    //답글 달기
    ResCreateReplyDTO createReply(long commentId, ReqCreateReplyDTO reqCreateReplyDTO, long memberId);
    //답글 수정
    ResUpdateReplyDTO updateReply(long replyId, ReqUpdateReplyDTO reqUpdateReplyDTO, long memberId);
    //답글 삭제
