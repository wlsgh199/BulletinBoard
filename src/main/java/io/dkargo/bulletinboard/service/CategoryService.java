...
public interface CategoryService {
    //카테고리 전체 조회
    List<ResCategoryDTO> findCategoryByParentIdOrderByCategoryNameAsc(Integer parentId);
    //카테고리 추가
    Category createCategory(ReqCreateCategoryDTO reqCreateCategoryDTO);

    //카테고리 이름 수정
    void updateCategoryName(Long categoryId, ReqUpdateCategoryNameDTO reqUpdateCategoryNameDTO);
    //카테고리 삭제
