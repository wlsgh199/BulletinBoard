...
//
//        //given
//        List<ResFindCategoryDTO> categoryList = new ArrayList<>();
//
//        for (int i = 0; i < 5; i++) {
//            categoryList.add( new ResFindCategoryDTO(new Category(parentId, "대")));
//        }
//
//        given(categoryService.findCategoryByParentIdOrderByCategoryNameAsc(parentId)).willReturn(categoryList);
//
//        //when
//        List<ResFindCategoryDTO> findCategories = categoryService.findCategoryByParentIdOrderByCategoryNameAsc(parentId);
//
//        //then
