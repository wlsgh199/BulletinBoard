...
//
//        postService.createPost(reqAddPostDTO);
//
...
//        Post post = postList.get(postList.size() - 1);
//
//        ReqUpdatePostDTO reqUpdatePostDTO = new ReqUpdatePostDTO();
//        reqUpdatePostDTO.setId(post.getId());
//        reqUpdatePostDTO.setTitle("put after");
//        reqUpdatePostDTO.setContent("put after");
//        reqUpdatePostDTO.setCategoryId(3L);
//        reqUpdatePostDTO.setUserId(1L);
//        reqUpdatePostDTO.setPostOpenUseFlag(false);
//        reqUpdatePostDTO.setReplyCommentUseFlag(false);
//
//        postService.updatePost(reqUpdatePostDTO);
//
//        Post findPost = postRepository.findById(post.getId()).orElse(null);
//
